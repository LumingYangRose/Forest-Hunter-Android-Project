...
public class Hunting3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hunting_view3);
        ...
        ImageView test = findViewById(R.id.test_sword_view);
        test.setImageResource(R.drawable.sword);
        test.setX(600);
        test.setY(600);
...
//                System.out.println("rose here");
    ...
    public void pauseMenu(View view) {
        ...
        dialog = new AlertDialog.Builder(Hunting3.this);
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            retry_game.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(getContext(), Hunting3.class);
